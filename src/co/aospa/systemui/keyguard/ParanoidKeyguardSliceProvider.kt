...
package co.aospa.systemui.keyguard
...
import co.aospa.systemui.keyguard.SmartspaceWidgetReader.Companion.SMARTSPACE_WEATHER_URI
...
class ParanoidKeyguardSliceProvider : KeyguardSliceProvider() {
    ...
    companion object {
        private const val TAG = "ParanoidKeyguardSliceProvider"
